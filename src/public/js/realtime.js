...
function iniciarAplicacion() {
  ...
  function renderizarListaDeProductos(listaDeProductos) {
    ...
    listaDeProductos.forEach((producto) => {
      const isOwner = currentUser.role === 'admin' || (currentUser.role === 'premium' && producto.owner === currentUser.email);
      ...
      productosHTML += `
        <div id="producto-${producto._id}">
          <div>
            ...
            <div>
              ${isOwner ? `<button type="button" onclick="eliminarProducto('${producto._id}')">Eliminar</button>
